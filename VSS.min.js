...
let data=[
  ...
  [
 {
   "ques":"Bãi biển Thiên Cầm nằm ở tỉnh nào của nước ta? ",
   "point":10,
 },
 {
  "ques":"Con sông nào chảy qua nhiều quốc gia châu Á nhất? ",
  "point":10
},
{
  "ques":"Khi nói về vàng, ta thường hay nói: “Vàng 4 số 9”, “Vàng 5 số 9”,... Bạn hãy cho biết ý nghĩa của những con số 9 này.",
  "point":20
},
{
  "ques":"Có bao nhiêu số có dạng 36abc chia hết cho cả 2, 3, 5 và 9?",
  "point":30
},
{
  "ques":": Ở các nhà hàng phục vụ những món ăn được chế biến từ ba ba, ba ba sẽ được nhân viên nhà hàng cắt tiết ngay tại bàn trước sự chứng kiến của thực khách. Hãy giải thích lý do của việc làm này.",
  "point":30
},
{
  "ques":", huyện nào của tỉnh Vĩnh Phúc được sáp nhập vào Hà Nội",
  "point":10
},
{
  "ques":"Vào ngày Tết, người ta treo cây nêu trước nhà với mong muốn điều gì? ",
  "point":10
},
{
  "ques":"Nước ta đã đánh bại những quân xâm lược nào trên sông Bạch Đằng?",
  "point":20
},
{
  "ques":"Tại sao ở các loại cây rễ củ, ta cần thu hoạch củ trước khi ra hoa?",
  "point":30
},
{
  "ques":"): Nêu các sản phẩm tạo thành khi điện phân dung dịch NaCl không màng ngăn.",
  "point":30
},
{
  "ques":"Những lý thuyết về tích phân, vi phân, đạo hàm là những lý thuyết thuộc mảng lĩnh vực nào của Toán học? ",
  "point":10
},
{
  "ques":"Quốc gia nào nằm kẹp giữa Trung Quốc và Nga? ",
  "point":10
},
{
  "ques":"Bạn hãy giải thích cơ chế hoạt động của vaccine",
  "point":20
},
{
  "ques":"Vì sao những đám mây lại có thể mang điện tích?",
  "point":30
},
{
  "ques":"Mời bạn trả lời câu hỏi sau:",
  "point":30
},
{
  "ques":"Vào những ngày đầu tháng âm lịch, trăng mọc vào ban ngày và lặn vào ban đêm. Nhưng tại sao hầu như ta không thể nhìn thấy mặt trăng vào ban ngày?",
  "point":10
},
{
  "ques":"Hình chóp ngũ giác đều có bao nhiêu cạnh? ",
  "point":10
},
{
  "ques":"Al(OH)3, Pb(OH)2, NaOH, Cu(OH)2, Sn(OH)2, Ba(OH)2, những hidroxit nào là hidroxit lưỡng tính?",
  "point":20
},
{
  "ques":"Thành phần của dịch vị dạ dày bao gồm 95% là nước, 5% còn lại bao gồm những gì?",
  "point":20
},
{
  "ques":"Sắp xếp các ngọn núi sau theo thứ tự từ Bắc vào Nam: Tà Xùa, Fansipan, Bà Đen, Chứa Chan, Hồng Lĩnh.",
  "point":30
},
]